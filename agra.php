...
if(!isset($_SESSION['city']))
	{
		$sql_city=mysql_query("select id from city where city_name='Agra'");
		...
		<div class="spotlight1">
		      <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px;height:650px; width: 1500px; overflow: hidden; visibility: hidden; z-index:-1;">
                ...
                <div data-u="slides"   style="cursor: pointer; position: absolute; top: 0px; left: 0px; width: 1500px;  overflow:hidden; z-index:-1; height:650px;">
					...
					<img data-u="image" src="assets/banners/Agra.jpg" /> 
                ...
                <div class="container" id="serviced">
                    <div class="row">
                      <div class="col-lg-12 col-md-12 what-client-say" style="margin-top:5%;">
							...
							{
								echo '<h2 class="about-title mist"><span style="font-size: 35px; font-family: ab2; color: #000;font-weight: bold;">Services<span style="color: #004066;">&nbsp;in&nbsp;'.$citiname.'</span></span></h2>';	
							}
