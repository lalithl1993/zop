...
?>
<?php
$sql=mysql_query("SELECT a.bikename, a.price_wkd,a.price_wknd,a.deposit,a.dlimit,b.name,b.address,b.contact from fleet a,vendors b where a.vid = b.vid and b.city='bangalore';");
