		...
		<!--	<div class="guit" style="width:120px;height:35px;font-size:24px;padding-left:5px;"><b style="width:10px;heght:30px;">Z<b><span>ZopRent</span></div>-->
            ...
            <div class="row">
				...
				<div class="col-xs-12 col-md-3 col-lg-3">
                    <div class="panel panel-default height">
                        <div class="panel-heading" style="font-size:20px;">Invoice No.& Date</div>
						<div class="panel-body">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                <tr>
									...
									<td class="text-right" style="font-size:20px;"><strong><?php echo $ftotal;?></strong></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="highrow text-right" style="font-size:20px;"><strong><?php echo $ftotal;?></strong></td>
                                </tr>
