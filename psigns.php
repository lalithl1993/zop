...
if(isset($_POST['send_mail']))
{
	$emailTo = 'zoprent@gmail.com';
		...
		$email_body .= "Phone : ".$phone."\n\n";
			...
			header('Location:psigns.php#success');
}
if(isset($_POST['signup']))
{
	...
	$_SESSION['user_otp']=$otp;		
			...
			/*-----------SMS END---------------------*/
			header('location:psigns.php#otp');
}
?>
					...
					jQuery.ajax({
						...
						success:function(response)
						{
							data=response;
							 if($.trim(data) === "success")
							{
								window.location="psigns.php#otp";
							}
							else
							{
         		...
         		if(email!="")
         			{
         				jQuery.ajax({
         								type:"POST",
         								url:"ajaxs.php?f=check_email_available",
         								datatype:"text",
         								data:{email:email},
         								success:function(response)
         								{
         		...
         		if(phone!="")
         			{
         				jQuery.ajax({
								type:"POST",
								url:"ajaxs.php?f=check_phone_available",
								datatype:"text",
								data:{phone:phone},
								success:function(response)
								{
       ...
       <?php include 'menu.php';?>
		...
		<div class="spotlight1">
		     <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1000px; height:350px; overflow: hidden; visibility:hidden;">
                ...
                <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1000px; height:300px; overflow: hidden;">
                    <div data-p="225.00" style="display: none;">
                       <img data-u="image" src="assets/banners/bengaluru-min.jpg"></img>
			...
			<?php
																	...
																	{
																		echo '<h2 class="about-title line-hori" ><span style="font-size: 35px; font-family: ab2; color: #000;font-weight: bold;">Our  Terms & <span style="color: #004066;">Condition</span></span></h2>
																	...
																	{
																		echo '
																		<h2 class="about-title line-hori" ><span style="font-size: 35px; font-family: ab2; color: #000;font-weight: bold;">Our <span style="color: #004066;">Services</span></span></h2>
...
//echo "You have selected :" .$_SESSION['selected_val']; // Displaying Selected Value
...
?>
<?php
/*$bike_status = 'unchecked';
    $car_status = 'unchecked';
	 $both_status = 'unchecked';
...
<!--<FORM name ="form1" method ="post" action ="">
   ...
   <?PHP //print $bike_status; ?>
   >Bike
   <Input type = 'Radio' Name ='gender' value= 'female' 
   <?PHP //print $car_status; ?>
   >Car
   <Input type = 'Radio' Name ='gender' value= 'both' 
   <?PHP //print $both_status; ?>
   >Both
   <P>
   <Input type = "Submit" Name = "Submit1" VALUE = "Select a Radio Button">
</FORM>-->
<!--<FORM name ="form1" method ="post" action ="">
   <Input type = 'Radio' Name ='gender' value= 'Bikes'
   
   >Bike
   <Input type = 'Radio' Name ='gender' value= 'Cars' 
...
<?php
																	...
																	echo '
<div class="col-lg-8" style="margin-left:550px;">																	
<FORM name="form1" method="post" action="">
   <input class="option-input radio" type="Radio" Name ="gender" value="Bikes"/> Bike
   <Input  class="option-input radio" type="Radio" Name ="gender" value="Cars"/> Car
   <Input  class="option-input radio" type ="Radio" Name ="gender" value="Both"/> Both
   <Input class="btn btn-primary" type = "Submit" Name ="Submit1" VALUE = "Select Your Choice"/>
</FORM>
</div>
<br/><br/>

					<div class="form-group">
        <label class="col-xs-12 control-label" style="margin-left:600px">Terms and Agreement</label>
        <div class="col-xs-12">
		<div>';
		if($selected_val == 'Bikes'){
echo '<iframe src="document/bike.pdf" width="1200px" height="600px" style="overflow:auto;border:5px ridge blue;margin-left:100px;">myDocument</iframe>';
}
	else if($selected_val == 'Cars'){
echo '<iframe src="document/partner.pdf" width="1200px" height="600px" style="overflow:auto;border:5px ridge blue;margin-left:100px;">myDocument</iframe>';
}

else if($selected_val == 'Both'){
echo '<iframe src="document/bike.pdf" width="1200px" height="600px" style="overflow:auto;border:5px ridge blue;margin-left:100px;">myDocument</iframe>
';
//echo '<div style="border: 1px solid #e5e5e5; height: 1200px; overflow: auto; padding: 10px;">
echo '<iframe src="document/partner.pdf" width="1200px" height="600px" style="overflow:auto;border:5px ridge blue;margin-left:100px;">myDocument</iframe>';
 //</div>';
...
echo'
            ...
            <!--<div style="border: 1px solid #e5e5e5; height: 1200px; overflow: auto; padding: 10px;">
			<iframe src="document/partner.pdf" width="1200px" height="600px" style="overflow:auto;border:5px ridge blue;margin-left:100px;">myDocument</iframe>
...
<form method="POST" action="vendordet.php">
 <label class="control-label" for="confirm_agree">
											 ...
											 <input type="submit" class="btn btn-primary" id="book_now" name="book_now" value="Accept">
</label>
</form>
</div>';
}
													...
													while($res=mysql_fetch_array($qry))
													{
																...
																<div class="right-block">
																	<div class="caption" style="text-align: center;">
																		...
																		<h4 style="color: #606062;font-family:ab2;font-weight:bold;font-size: 23px;">'.$cate_name.'</h4>
...
return false;
            ...
            <!--Block Spotlight2  -->
           <div class="about-us about-demo-1" style=" padding-bottom: 4%;padding-top: 0%;">
                <div class="container" style="padding-bottom: 5%; width: 100%;">
                   ...
                   <div class="mudule list-services row" style="padding-top:3%;">
                        <div class="item-service col-lg-3 col-md-3 col-sm-3 col-xs-15">
                            ...
                            <h3 style="text-align: center;font-family:ab2;color:#000;line-height:23px;font-size:15px;font-weight: bold;">Set the time from when you want the product for rent</h3>
...
margin-bottom:0px;background-position: 50% 2px;    background-size: cover; width: 100%;background-attachment: fixed !important;background: url(assets/b3-min.jpg) no-repeat;">
                <h3 style="text-align: center;padding-bottom:3%;  font-family: ab2; font-size: 35px;color:#000;padding-top: 3%;font-weight:bold;color:#fff;"><span>What Our Customer<span style="color:#01a9c4;"> Says about Us</span></h3>
                    ...
                    <div class="slider-clients-say" style="text-align: center;">
                         <div class="item block_content">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <center><img src="assets/udai.jpg" style="width:100px;margin-top:7%;" /></center>
						 ...
						 <div class="item block_content">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <center><img src="assets/prashant.jpg" style="width:100px;margin-top:7%;" /></center>
                            ...
                            <div class="info">
                                ...
                                <div class="text" style="font-size:17px;color:#fff;">"Awesome bikes form Zoprent, I recommend this for everyone who is looking for rents in Bangalore. Thanks you Team."</div>
						...
						<div class="item block_content">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <center><img src="assets/ang.jpg" style="width:100px;margin-top:7%;" /></center>
...
<br/>Thanks"</div>
                        ...
                        <div class="item block_content">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <center><img src="assets/Annesh.jpg" style="width:100px;margin-top:7%;" /></center>
	...
	<div class="remodal" data-remodal-id="success" style="border: 4px dotted #18a9c3;">
			 ...
			 <div class="remodal" data-remodal-id="signin" style="box-shadow: 0 -1px 23px rgba(0,0,0,.06), 0 4px 6px rgba(0,0,0,.09);    border: 2px solid #01a9c4;">
				...
				<div class="modal-body" style="padding:0px;">
					<div class="row">
										...
										<h3 style="font-family:ab3;">Sign In</h3>
											...
											<div class="form-group required">
												<div class="col-sm-12" style="margin-top: 10%;">
													<span style="color:#39a6b9;font-size:11px;color:#39a6b9;text-transform: initial;">Not registered with us? <a href="psigns.php#signup" style="color:#39a6b9;font-size:11px;color:#39a6b9;text-transform: initial;">Signup here!</a></span>
												</div>
											</div>
								</form>
							</div>
						...
						<img src="assets/icons/1.png" style="display:inline-block;font-size: 40px;height: 40px;text-align: center;width: 40px;float: left;">
							<div class="feature-content">
								<h4 style="text-align:left;">Manage Fleet</h4>
								<p style="text-align:justify;">Partner can easily maintain their fleet.</p> 
							</div>
							
						</div>
						<div class="feature-box"> 
							<img src="assets/icons/2.png" style="display: inline-block;font-size: 40px;height: 40px;text-align: center;width: 40px;float: left;">
							<div class="feature-content">
								<h4 style="text-align:left;">Easy Information</h4>
								<p style="text-align:justify;">Registered partner can share information about product to Zoprent</p> 
							</div>
							
						</div>
						<div class="feature-box"> 
							<img src="assets/icons/3.png" style="display: inline-block;font-size: 40px;height: 40px;text-align: center;width: 40px;float: left;">
							<div class="feature-content">
								<h4 style="text-align:left;">Easy Payment </h4>
								<p style="text-align:justify;">You wil be notified about the booking details and paid from Zoprent</p> 
							</div>
			 ...
			 <div class="remodal" data-remodal-id="signup" style="box-shadow: 0 -1px 23px rgba(0,0,0,.06), 0 4px 6px rgba(0,0,0,.09); border: 2px solid #01a9c4;">
								...
								<form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
									<fieldset style=""> 
										...
										<h3 style="font-family:ab3;">Sign Up</h3>
											...
											<div class="form-group required">
												<div class="col-sm-12" style="margin-top: 10%;">
													<span style="color:#39a6b9;font-size:11px;">Already have an account? <a href="psigns.php#signin" style="color:#39a6b9;">Signin here.</a></span>
												</div>
											</div>
				...
				<img src="assets/icons/1.png" style="display: inline-block;font-size: 40px;height: 40px;text-align: center;width: 40px;float: left;">
							<div class="feature-content">
								<h4 style="text-align:left;">Easy to maintain fleet detail.</h4>
								<p style="text-align:justify;">Partner can enter all details for information.</p> 
							</div>
						...
						<div class="feature-box"> 
							<img src="assets/icons/2.png" style="display: inline-block;font-size: 40px;height: 40px;text-align: center;width: 40px;float: left;">
							<div class="feature-content">
								<h4 style="text-align:left;">Easy Buisness</h4>
								<p style="text-align:justify;">Registered partner will get buisness benefits from Zoprent</p> 
							</div>
						...
						<div class="feature-box"> 
							<img src="assets/icons/3.png" style="display: inline-block;font-size: 40px;height: 40px;text-align: center;width: 40px;float: left;">
							<div class="feature-content">
								<h4 style="text-align:left;">Ease of Information</h4>
								<p style="text-align:justify;">You wil be notified about the your product booking from Zoprent</p> 
							</div>
							
						</div>
						<div class="feature-box"> 
							<img src="assets/icons/5.png" style="display: inline-block;font-size: 40px;height: 40px;text-align: center;width: 40px;float: left;">
							<div class="feature-content">
								<h4 style="text-align:left;">Verify Mobile Number</h4>
								<p style="text-align:justify;">Please verify your mobile number and get the booking details through SMS!</p> 
							</div>
				...
				<div class="modal-body" style="padding:0px;">
					<div class="row">
						...
						<div class="feature-box"> 
							...
							<div class="feature-content">
								<h4 style="text-align:left;">Verify Mobile Number</h4>
								<p style="text-align:justify;">Please verify your mobile number to get  details through SMS!</p> 
							</div>
