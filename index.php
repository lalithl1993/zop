...
if(!isset($_SESSION['city']))
	{
		$sql_city=mysql_query("select id from city where city_name='Bangalore'");
...
<head>
    ...
    <!-- Basic page needs
	============================================ -->
  <title>ZopRent – Self Driven Car/Bikes and Stay Rental |  Bikes/Car for Rent</title>
    <meta charset="utf-8">
	<meta name="msvalidate.01" content="BB36471903B1CCE02D0D60EFC38ABBC8" />
	<meta name="keywords" content="Rent Bikes, Rent Cars, Rent A Bike, Rent A Car, Bike Rental, Car Rental, Stay Rental, Book A Stay, car rental Bangalore, self drive car Bangalore, self drive car rental, Car on rent, self drive car rentals, Bike rentals in Bangalore, Rent Bike In Goa, Rent Car in Goa">
	 
    <meta name="description" content="ZopRent is India's largest online booking platform for Bikes/Car and Stay rental. We are present in Bangalore, Mysore, Goa, Ooty, Ahmedabad, Chandigarh, Delhi, Mumbai, Hyderabad, Ladakh, Manali, Pondicherry and in 21+locations in India. Rent Bike/Car with affordable prices. Download our App Now!">    
...
@media screen(max-width: 590px) {
        
        #modsr {
         margin-right:50px;		  /* New width for small modal */
        }
    }
		...
		<div class="spotlight1">
		      <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px;height:650px; width: 1500px; overflow: hidden; visibility: hidden; z-index:-1;">
                ...
                <div data-u="slides"   style="cursor: pointer; position: absolute; top: 0px; left: 0px; width: 1500px;  overflow:hidden; z-index:-1; height:650px;">
					...
					<?php 
					$list = ['Bangalore','Goa','Ahmedabad','Mumbai','Agra','Ooty','Pondicherry','Shimla','Mysore','Hyderabad','Pune','Jaipur','Udaipur','Andaman','Dehra Dun','Delhi','Ladakh','Haridwar','Mussoorie','Chandigarh','Rishikesh','Ahmedabad','Manali'];
						if(in_array($citiname,$list)){      
							echo '<img data-u="image" src="assets/banners/'.$citiname.'.jpg" />';     
						} else {   
							echo '<img data-u="image" src="assets/banners/Bangalore.jpg" />';       
						}
         ...
         portrait: { 
			...
			<div class="about-us about-demo-1" id="my_pro" >
                <div class="container" id="serviced">
                    <div class="row">
                      <div class="col-lg-12 col-md-12 what-client-say" style="margin-top:5%;">
							...
							{
								echo '<h2 class="about-title" id="mist"><span style="font-size: 30px; font-family: ab2; color: #000;font-weight: bold;">Our <span style="color: #004066;">Services</span>&nbsp;in&nbsp;'.$citiname.'</span></h2>';	
							}
...
<br/>Thanks"</div>
    ...
    float: left;"/>
						...
						<form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="form-group required">
									...
									<div class="col-sm-12">
										<input type="text" name="phone" value="" id="phone" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" class="form-control" required placeholder="Contact no" style="height: 54px;border: 1px solid #f2f2f2;border-radius:3px;display:block;">
										</div>
									</div>
								</fieldset>
								<div class="buttons">
  ...
  <div class="modal-dialog" id="modalsh" style="border: 3px solid #18a9c3;top:-40px;">  
    <!-- Modal content--> 
    <div class="modal-content"> 
	<h3 style="text-align:center;color:black;">Select your location for booking: </h3>  
	    <div class="modal-body" id="smalls"> 
                ...
                <?php
							  $i=1;
									...
									if($i==1)
									{
										...
										<div class="col-lg-12 col-md-12 col-sm-8" id="pads">';
									}										
									echo '	
							...
							<h4 style="color:black;text-align: center;margin-top: 4%; width:100%;text-align:center;" id="name">'.$res1['city_name'].'</h4></center>
							</a>
							</div>
							';
			...
			<!--<div class="remodal" data-remodal-id="location" style="border: 4px solid #18a9c3;overflow-x: hidden;">
				...
				<div class="container">
					<div class="module custom-polyci">
							...
							<div class="col-lg-2 col-md-2 col-sm-12" id="modalsh" style="margin-left:-5px">
							<a href="javascript:void(0);" id='.$res1['id'].' onclick="change_city_pop(this.id);">
							<center><img src="admin/'.$res1['image'].'"/>
							<h4 style="color:black;text-align: center;margin-top: 4%; width:100%;text-align:center;" id="name">'.$res1['city_name'].'</h4></center>
							</a>
